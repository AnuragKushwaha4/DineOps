...
export const tables = [
    { id: 1, name: "Family Table", status: "Booked", initial: "AM", seats: 4 },
    { id: 2, name: "Party Table", status: "Available", initial: "MB", seats: 6 },
    { id: 3, name: "Couple Table", status: "Booked", initial: "JS", seats: 2 },
    { id: 4, name: "Family Table", status: "Available", initial: "HR", seats: 4 },
    { id: 5, name: "Couple Table", status: "Booked", initial: "PL", seats: 2 },
    { id: 6, name: "Family Table", status: "Available", initial: "RT", seats: 4 },
    { id: 7, name: "Couple Table", status: "Booked", initial: "LC", seats: 2 },
    { id: 8, name: "Party Table", status: "Available", initial: "DP", seats: 5 },
    { id: 9, name: "Party Table", status: "Booked", initial: "NK", seats: 6 },
    { id: 10, name: "Party Table", status: "Available", initial: "SB", seats: 6 },
    { id: 11, name: "Family Table", status: "Booked", initial: "GT", seats: 4 },
    { id: 12, name: "Party Table", status: "Available", initial: "JS", seats: 6 },
    { id: 13, name: "Couple Table", status: "Booked", initial: "EK", seats: 2 },
    { id: 14, name: "Party Table", status: "Available", initial: "QN", seats: 6 },
    { id: 15, name: "Family Table", status: "Booked", initial: "TW", seats: 4 }
  ];
